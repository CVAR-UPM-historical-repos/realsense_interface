...
#ifndef a_FIND_DEVICE_WITH_STREAMS_HPP_
#define a_FIND_DEVICE_WITH_STREAMS_HPP_
...
// bool hola(std::vector <rs2_stream> stream_requests, std::string& out_serial)
// {
//     rs2::context ctx;
...
#endif //FIND_DEVICE_WITH_STREAMS_HPP_